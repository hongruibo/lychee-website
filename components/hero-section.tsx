...
export function HeroSection() {
  return (
    <section className="section-frame hero-section pt-10 md:pt-16">
      <div className="space-y-10 rounded-[2.25rem] border border-white/60 bg-white/72 px-6 py-16 shadow-[0_20px_70px_rgba(15,23,42,0.06)] backdrop-blur-[8px] md:px-10 md:py-24">
        ...
        <div className="hero-visual relative mx-auto min-h-[24rem] w-full max-w-[1120px] overflow-hidden rounded-[2rem] border border-black/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(245,247,244,0.98))]">
          ...
          <div className="absolute left-6 top-6 rounded-full border border-black/8 bg-white/82 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-[color:var(--muted)] md:left-8 md:top-8">
            Battery-first wedge
          </div>

          <div className="absolute inset-x-6 bottom-6 top-20 md:inset-x-8 md:bottom-8 md:top-24">
            <div className="relative h-full overflow-hidden rounded-[1.75rem] border border-black/8 bg-white/70">
              ...
              <div className="absolute left-[10%] top-[22%] h-16 w-16 rounded-full border border-[color:var(--accent-soft)] bg-white shadow-[0_10px_30px_rgba(15,23,42,0.04)]" />
              ...
              <div className="absolute left-[45%] top-[20%] h-24 w-24 rounded-full border border-[color:var(--accent-soft)] bg-white" />
              ...
              <div className="absolute bottom-5 left-5 right-5 grid gap-3 md:grid-cols-3">
                {[
                  ...
                  <div key={title} className="rounded-[1.25rem] border border-black/8 bg-white/82 px-4 py-4">
