  ...
  return (
    <header className="fixed inset-x-0 top-0 z-[1000]">
      <div className="site-shell pt-3">
        <div className="nav-shell flex w-full flex-col rounded-[1.35rem] border border-[color:var(--line-strong)] bg-[color:var(--surface)]/92 shadow-[var(--shadow-soft)] backdrop-blur-[24px] transition-[background-color,border-color,box-shadow] duration-300">
