...
export function SiteFooter() {
  return (
    <footer className="site-footer border-t border-[color:var(--line)] bg-[color:var(--surface)] backdrop-blur-[8px]">
      <div className="site-shell pt-14">
        <div className="footer-top border-b border-[color:var(--line-subtle)] pb-8">
          <div className="flex items-center gap-4">
            <LogoMark size={48} />
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.2em] text-[color:var(--ink)]" translate="no">
                Lychee Labs
              </p>
      ...
      <div className="footer-bottom site-shell flex items-center justify-between gap-4 border-t border-[color:var(--line-subtle)] py-5 text-xs text-[color:var(--muted)]">
