...
export function ContactPanel({
  ...
  return (
    <section className="section-frame">
      <div className="grid gap-8 rounded-[2rem] border border-[color:var(--line)] bg-[color:var(--surface)] px-6 py-10 backdrop-blur-[8px] md:px-10 md:py-12 lg:grid-cols-[0.92fr_1.08fr]">
        ...
        <div className="grid gap-4">
          {[
            ...
            <a
              ...
              className="rounded-[1.5rem] border border-[color:var(--line)] bg-[color:var(--surface-soft)] p-5 transition-colors duration-200 hover:border-[color:var(--accent-soft)]"
            >
